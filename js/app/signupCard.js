        ...
        $.post(
            ...
            function (data) {
                if (data.code !== 0) {
                    ...
                    location.href = location.origin  + location.pathname +'/dmSuccess';
                }
            });
    });
})();
        ...
        function scanMedia(mediaId) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (data && data === 1) {
                        location.href = location.origin + location.pathname + '/dmCardRegistered';
                    }
                    if (data && data === 2) {
                        location.href = location.origin + location.pathname + '/dmSuccess';
                    }
                    if (data && data === 3) {
                        location.href = location.origin + location.pathname + '/dmCardSuccess';
                    }
                },
                error: function (err) {
                    hideScanLoading();
